package aluminium.math;

import aluminium.math.geom.Vec2;
import aluminium.math.geom.Vec3;
...
public class Mat{
     ...
     * @return This matrix for the purpose of chaining operations.
     * @throws AluRuntimeException if the matrix is singular (not invertible)
     */
    public Mat inv(){
        float det = det();
        if(det == 0) throw new AluRuntimeException("Can't invert a singular matrix");
