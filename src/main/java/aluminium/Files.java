...
public interface Files{
     ...
     * @throws AluRuntimeException if the type is classpath or internal and the file does not exist.
     * @see FileType
     */
    ...
    /**
     * @return the local storage path directory. This is the private aluminium.files directory on Android and the directory of the jar on the
     * desktop.
     */
    ...
    enum FileType{
        /**
         * Path relative to the root of the classpath. Classpath aluminium.files are always readonly
         */
        classpath,

        /**
         * Path relative to the asset directory on Android and to the application's root directory on the desktop. On the desktop,
         * if the file is not found, then the classpath is checked. This enables aluminium.files to be found when using JWS or applets.
         * Internal aluminium.files are always readonly.
         */
        internal,
        ...
        /**
         * Path that is a fully qualified, absolute filesystem path. To ensure portability across platforms use absolute aluminium.files only
         * when absolutely (heh) necessary.
         */
        absolute,

        /** Path relative to the private aluminium.files directory on Android and to the application's root directory on the desktop. */
        local
    }
}